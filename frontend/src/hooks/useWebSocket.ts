...
export function useWebSocket<T = unknown>(
  ...
  // Create stable dependency keys to avoid spread elements in deps array
  ...
  }, [depsKey, messageTypesKey, messageTypes]);

  // Send message function
  const send = useCallback((type: string, payload: unknown, roomId?: string) => {
