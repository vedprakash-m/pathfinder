...
from backend.app.repositories.cosmos_unified import UnifiedCosmosRepository
...
class FamilyAtomicValidator:
    ...
    async def setup_test_data(self):
        ...
        try:
            ...
            existing_family = next((f for f in user_families if f.name == "Family Atomic Test Family"), None)
        ...
        try:
            ...
            if family and family.admin_user_id == self.test_user_id:
                self.log_result(
                    ...
                    True,
                    "Family admin correctly set and accessible"
                )
            else:
                self.log_result(
                    "Family Admin Authority",
            ...
            self.log_result(
                "Family Admin Authority",
                False,
                f"Failed to validate family admin: {e}"
            )
        ...
        try:
            ...
            if updated_family and updated_family.description == "Updated by admin test":
                self.log_result(
                    ...
                    True,
                    "Family admin can update family details"
                )
            else:
                self.log_result(
                    "Admin Update Authority",
                    False,
                    "Family admin cannot update family details"
                )
        except Exception as e:
            self.log_result(
                "Admin Update Authority",
                False,
                f"Admin update failed: {e}"
            )
        ...
        try:
            ...
            if belongs_to_family:
                self.log_result(
                    "Family Membership",
                    True,
                    "User correctly associated with family"
                )
            else:
                self.log_result(
                    "Family Membership",
                    False,
                    "User not properly associated with family"
                )
        except Exception as e:
            self.log_result(
                "Family Membership",
                False,
                f"Family membership check failed: {e}"
            )
        ...
        try:
            ...
            if family and self.test_user_id in family.member_ids:
                self.log_result(
                    ...
                    True,
                    "User properly included in family member list"
                )
            else:
                self.log_result(
                    "Atomic Member Management",
            ...
            self.log_result(
                "Atomic Member Management",
                False,
                f"Member management check failed: {e}"
            )
    ...
    async def validate_family_permissions_system(self):
        ...
        try:
            ...
            if family:
                self.log_result(
                    "Family Read Permissions",
                    True,
                    "Family admin can read family data"
                )
            else:
                self.log_result(
                    "Family Read Permissions",
                    False,
                    "Family admin cannot read family data"
                )
        except Exception as e:
            self.log_result(
                "Family Read Permissions",
                False,
                f"Family read permission check failed: {e}"
            )
        ...
        try:
            ...
            if second_family:
                self.log_result(
                    ...
                    True,
                    "Family admin can create multiple families"
                )
                # Cleanup
        ...
        try:
            ...
            if invitation:
                self.log_result(
                    ...
                    True,
                    "Family admin can create invitations"
                )
                # Cleanup
                ...
                self.log_result(
                    "Family Invitation System",
                    False,
                    "Family admin cannot create invitations"
                )
        except Exception as e:
            self.log_result(
                "Family Invitation System",
                False,
                f"Family invitation system check failed: {e}"
            )
        ...
        try:
            ...
            if user and user.role == UserRole.FAMILY_ADMIN:
                self.log_result(
                    "Role-Based Access",
                    True,
                    "User correctly assigned Family Admin role"
                )
            else:
                self.log_result(
                    "Role-Based Access",
            ...
            self.log_result(
                "Role-Based Access",
                False,
                f"Role-based access check failed: {e}"
            )
        ...
        try:
            ...
            if family:
                ...
                self.log_result(
                    "Data Consistency",
                    False,
                    "Family not found for consistency check"
                )
        except Exception as e:
            self.log_result(
                "Data Consistency",
                False,
                f"Data consistency check failed: {e}"
            )
