...
class TestTaskQueueOperations:
    ...
    def test_generate_itinerary_async_success(
    ...
    def test_generate_itinerary_async_failure(
        self, sample_trip_id, sample_preferences, sample_user_id
    ):
    ...
    def test_generate_daily_cost_report_success(self):
        ...
        with patch("app.tasks.ai_tasks_alt.task_queue") as mock_queue:
            ...
            assert result["status"] == "queued"
            mock_queue.add_task.assert_called_once_with("generate_cost_report", {})
...
class TestReturnValues:
    ...
    def test_generate_itinerary_return_structure(
        self, sample_trip_id, sample_preferences, sample_user_id
    ):
