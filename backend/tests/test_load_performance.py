...
class LoadTestMetrics:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "p95_response_time": statistics.quantiles(self.response_times, n=20)[18] if len(self.response_times) > 1 else 0,
...
class TestLoadPerformance:
    ...
    def test_concurrent_health_checks(self):
        ...
        assert summary["total_requests"] >= concurrent_users * requests_per_user * 0.8  # Allow some failures
    ...
    def test_sustained_load(self):
        ...
        assert summary["p95_response_time"] < 2.0  # 95th percentile under 2 seconds
    ...
    def test_response_time_consistency(self):
        ...
        assert max_time < avg_time * 3, f"Inconsistent response times: avg={avg_time:.3f}, max={max_time:.3f}"
...
class TestResourceLimits:
    ...
    def test_rapid_requests(self):
        ...
        for i in range(30):
            ...
            assert response.status_code in [200, 429, 503]  # Allow rate limiting
