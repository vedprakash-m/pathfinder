...
def migrate_file_to_cosmos(filepath):
    ...
    if 'get_cosmos_repository' in content and 'from ..core.database_unified import get_cosmos_repository' not in content:
...
def main():
    ...
    if updated_files:
        ...
        print(f"3. Run security audit again to verify improved Cosmos DB usage")
