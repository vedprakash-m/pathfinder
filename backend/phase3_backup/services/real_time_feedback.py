...
class FeedbackItem:
    ...
    family_id: str
    user_id: str
    # What they're commenting on (activity, accommodation, etc.)
    target_element: str
    content: str
...
class ChangeImpact:
    ...
    # Change in cost (positive = increase, negative = decrease)
    cost_delta: float
...
class RealTimeFeedbackService:
    ...
    def __init__(self, db: AsyncSession):
        ...
        self.feedback_store: Dict[
            str, List[FeedbackItem]
    ...
    async def submit_feedback(self, feedback_item: FeedbackItem) -> Dict[str, Any]:
        ...
        try:
            ...
            if feedback_item.feedback_type in [
...
async def get_feedback_dashboard_data(db: AsyncSession, trip_id: str) -> Dict[str, Any]:
    ...
    return {
        ...
        # Last 5 items
        "recent_feedback": all_feedback[-5:] if all_feedback else [],
