...
def upgrade() -> None:
    ...
    op.add_column(
        "family_members", sa.Column("accessibility_needs", sa.Text(), nullable=True)
    )
    op.add_column(
        "family_members", sa.Column("emergency_contact", sa.Text(), nullable=True)
    )
    ...
    op.alter_column(
        "users", "auth0_id", existing_type=sa.VARCHAR(length=255), nullable=True
    )
    op.alter_column(
        "users",
        "role",
    ...
    op.alter_column(
        "users", "onboarding_completed", existing_type=sa.BOOLEAN(), nullable=True
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "users", sa.Column("last_name", sa.VARCHAR(length=100), nullable=False)
    )
    op.add_column(
        "users", sa.Column("first_name", sa.VARCHAR(length=100), nullable=False)
    )
    op.add_column("users", sa.Column("date_of_birth", sa.DATE(), nullable=True))
    op.alter_column(
        "users", "onboarding_completed", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "users",
        "phone",
    ...
    op.alter_column(
        "users", "auth0_id", existing_type=sa.VARCHAR(length=255), nullable=False
    )
    ...
    op.add_column(
        "family_members", sa.Column("email", sa.VARCHAR(length=255), nullable=True)
    )
    op.add_column(
        "family_members", sa.Column("special_needs", sa.TEXT(), nullable=True)
    )
    op.alter_column(
        "family_members",
        "role",
