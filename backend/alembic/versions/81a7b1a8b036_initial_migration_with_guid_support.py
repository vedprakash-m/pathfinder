...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('HEAD', 'SPOUSE', 'CHILD', 'PARENT', 'SIBLING', 'RELATIVE', 'FRIEND', name='familymemberrole'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PLANNING', 'CONFIRMED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='tripstatus'), nullable=True),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('DRAFT', 'GENERATING', 'READY', 'APPROVED', 'MODIFIED', 'ARCHIVED', name='itinerarystatus'), nullable=True),
    ...
    sa.Column('type', sa.Enum('TRIP_INVITATION', 'TRIP_UPDATE', 'ITINERARY_READY', 'ITINERARY_UPDATE', 'FAMILY_INVITATION', 'RESERVATION_CONFIRMED', 'RESERVATION_CANCELLED', 'SYSTEM_ANNOUNCEMENT', 'CHAT_MESSAGE', name='notificationtype'), nullable=False),
    ...
    sa.Column('type', sa.Enum('ACCOMMODATION', 'RESTAURANT', 'ACTIVITY', 'ATTRACTION', 'TRANSPORTATION', 'RENTAL_CAR', 'FLIGHT', 'EVENT', 'TOUR', 'CUSTOM', name='reservationtype'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'CANCELLED', 'COMPLETED', 'NO_SHOW', 'REFUNDED', name='reservationstatus'), nullable=True),
    sa.Column('payment_status', sa.Enum('UNPAID', 'PARTIALLY_PAID', 'PAID', 'REFUNDED', 'FAILED', name='paymentstatus'), nullable=True),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    ...
    sa.Column('cancellation_policy', sa.Enum('FLEXIBLE', 'MODERATE', 'STRICT', 'NON_REFUNDABLE', name='cancellationpolicy'), nullable=True),
    ...
    op.create_table('trip_participations',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('trip_id', sa.String(length=36), nullable=False),
    sa.Column('family_id', sa.String(length=36), nullable=False),
    sa.Column('user_id', sa.String(length=36), nullable=False),
    sa.Column('status', sa.Enum('INVITED', 'CONFIRMED', 'DECLINED', 'PENDING', name='participationstatus'), nullable=True),
    ...
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('type', sa.Enum('ACCOMMODATION', 'DINING', 'ATTRACTION', 'ENTERTAINMENT', 'SHOPPING', 'OUTDOOR', 'CULTURAL', 'ADVENTURE', 'RELAXATION', 'TRANSPORTATION', 'CUSTOM', name='activitytype'), nullable=False),
    sa.Column('difficulty', sa.Enum('EASY', 'MODERATE', 'CHALLENGING', 'EXPERT', name='difficultylevel'), nullable=True),
    sa.Column('location_name', sa.String(length=200), nullable=True),
    sa.Column('address', sa.Text(), nullable=True),
    sa.Column('latitude', sa.Numeric(precision=10, scale=8), nullable=True),
    sa.Column('longitude', sa.Numeric(precision=11, scale=8), nullable=True),
