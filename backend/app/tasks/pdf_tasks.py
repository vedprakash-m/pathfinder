            ...
            try:
                ...
                current_task.update_state(
                    ...
                    meta={
                        "current": 10,
                        "total": 100,
                        "status": "Initializing PDF service",
                    },
                )
                ...
                current_task.update_state(
                    ...
                    meta={
                        "current": 60,
                        "total": 100,
                        "status": f"Generating {pdf_type} PDF",
                    },
                )
                ...
                logger.info(
                    f"Successfully generated {pdf_type} PDF for trip {trip_id}")
                ...
                logger.error(
                    f"Error generating {pdf_type} PDF for trip {trip_id}: {e}")
