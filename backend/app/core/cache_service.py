...
class AICacheService(CacheService):
    ...
    async def get_ai_response(self, prompt: str, model: str = "default", **kwargs) -> Optional[Dict]:
    ...
    async def set_ai_response(self, prompt: str, response: Dict, model: str = "default", **kwargs) -> bool:
