...
class ContextValidator:
    ...
    def __init__(self):
        ...
        self.trusted_networks = [
            ...
            for network in settings.TRUSTED_NETWORKS
        ]
    ...
    async def extract_context(self, request: Request, user_id: str, 
                           resource_type: str, action: str) -> AccessContext:
