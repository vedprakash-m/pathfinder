...
from ..core.ai_cost_management import get_ai_usage_stats, usage_tracker, ai_cost_tracker
...
class UsageStatsResponse(BaseModel):
    ...
    optimization_suggestions: list = Field(default_factory=list, description="Cost optimization suggestions")
...
async def get_cost_status(
    ...
    try:
        ...
        avg_cost = (
            ...
            if cost_status['daily_requests'] > 0 else 0.0
        )
...
async def validate_request_budget(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to validate request budget"
        )
