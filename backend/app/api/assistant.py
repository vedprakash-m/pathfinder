...
async def get_interaction_history(
    ...
    try:
        ...
        interactions = query.order_by(
            AssistantInteraction.created_at.desc()
...
async def get_interaction_details(
    ...
    try:
        ...
        # Get response cards
        response_cards = db.query(AIResponseCard).filter(
            AIResponseCard.interaction_id == interaction_id
        ).order_by(AIResponseCard.display_order).all()
...
async def dismiss_response_card(
    ...
    try:
        ...
        card = db.query(AIResponseCard).join(AssistantInteraction).filter(
        ...
        return {
            "success": True,
            "message": "Response card dismissed"
        }
