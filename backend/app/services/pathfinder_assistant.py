...
from app.models.ai_integration import (
    AssistantInteraction, AIResponseCard, ContextType, ResponseCardType,
...
class PathfinderAssistantService:
    ...
    async def _get_trip_suggestions(self, context: Dict[str, Any], user_id: str) -> List[Dict[str, Any]]:
    ...
    async def _get_family_suggestions(self, context: Dict[str, Any], user_id: str) -> List[Dict[str, Any]]:
