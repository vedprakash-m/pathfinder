...
class ItineraryDocumentService:
    ...
    async def update_itinerary(self, itinerary: ItineraryDocument) -> ItineraryDocument:
        ...
        result = await self.cosmos_service.replace_item(
            ...
            item=itinerary,
            partition_key_value=itinerary.trip_id
        )
    ...
    async def convert_from_sql(self, sql_itinerary: Any, include_days: bool = True) -> ItineraryDocument:
        """
                ...
                if sql_day.activities:
                    for sql_activity in sql_day.activities:
                        activity_doc = ItineraryActivityDocument(
                            ...
                            start_time=sql_activity.start_time.isoformat() if sql_activity.start_time else None,
                            end_time=sql_activity.end_time.isoformat() if sql_activity.end_time else None,
