...
def test_unified_repository():
    ...
    try:
        from app.core.database_unified import get_cosmos_repository, get_cosmos_service

        # Test repository creation
        _repo = get_cosmos_repository()
        logger.info("✅ Repository instance created")

        # Test service creation
        _service = get_cosmos_service()
...
async def test_auth_service_integration():
    ...
    try:
        ...
        _repo = get_cosmos_repository()
        _auth_service = UnifiedAuthService(repo)
