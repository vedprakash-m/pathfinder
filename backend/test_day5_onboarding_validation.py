...
class OnboardingValidationSuite:
        ...
        try:
            ...
            for template in templates:
                ...
                if template in template_maps:
                    ...
                    print(f"    ✅ {template}: {template_data['name']} - {template_data['duration']} days")
                else:
    ...
    async def test_sample_trip_performance(self) -> bool:
        ...
        try:
            ...
            if creation_time < target_time:
                ...
                print(f"  ❌ Sample trip creation: {creation_time:.3f}s (exceeds {target_time}s target)")
    ...
    async def test_onboarding_analytics_endpoints(self) -> bool:
        ...
        try:
            ...
            required_fields = [
                'sessionId', 'startTime', 'currentStep', 'completed'
            ]
    ...
    async def test_trip_template_completeness(self) -> bool:
        ...
        try:
            ...
            required_elements = [
                ...
                'budget', 'activities', 'decision_scenarios'
            ]
            ...
            for template_name, template_data in templates.items():
                ...
                if len(template_data.get('decision_scenarios', [])) < 1:
                    print(f"    ❌ Insufficient decision scenarios for interactive demo")
                    return False
