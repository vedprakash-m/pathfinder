...
def test_imports():
    ...
    try:
        # Test family models
        from app.models.family import InvitationStatus, FamilyInvitationModel, Family, FamilyMember, FamilyRole
...
async def test_email_service():
    ...
    try:
        ...
        if result is False:
            print("✅ Email service method executed (failed as expected - no email service configured)")
            return True
        else:
...
def check_migration_file():
    ...
    migration_path = Path(__file__).parent / "alembic" / "versions" / "add_family_invitations_table_20250528.py"
