...
from core.types import (
    LLMRequest, LLMResponse, LLMProvider, TokenUsage, 
    LLMRateLimitError, LLMServiceUnavailableError, LLMAuthenticationError,
    LLMValidationError
)
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            async with self._semaphore:
                ...
                logger.debug("Sending request to OpenAI", model=payload["model"], request_id=request_id)
