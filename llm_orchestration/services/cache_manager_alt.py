...
try:
    from core.types import LLMRequest, LLMResponse, LLMConfigurationError
except ImportError:
...
class AlternativeCacheManager:
    ...
    async def connect(self) -> None:
        ...
        logger.info("Alternative cache manager initialized (Redis-free)", db_path=str(self.cache_db_path))
            ...
            with sqlite3.connect(self.cache_db_path) as conn:
                ...
                if row:
                    ...
                    if current_time - created_at < ttl:
                        ...
                        self._add_to_memory_cache(cache_key, {
