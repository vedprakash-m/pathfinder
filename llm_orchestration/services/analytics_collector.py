...
import structlog
from core.types import LLMRequest, LLMResponse, TenantInfo, LLMProviderType, TaskType
...
class AnalyticsCollector:
    ...
    async def get_real_time_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "performance_summary": {
                ...
                "p95_response_time": self._calculate_percentile(response_times, 0.95) * 1000 if response_times else 0
            }
        }
    ...
    async def _cleanup_old_metrics(self) -> None:
        ...
        for buffer in [self.request_metrics, self.performance_metrics, 
                      self.cost_metrics, self.error_metrics, self.cache_metrics]:
