...
class LLMResponse(BaseModel):
    ...
    original_model_attempted: Optional[str] = Field(None, description="Original model if fallback occurred")
...
class TenantInfo(BaseModel):
    ...
    allowed_providers: List[LLMProvider] = Field(default_factory=list, description="Allowed LLM providers")
    ...
    priority_level: RequestPriority = Field(RequestPriority.NORMAL, description="Tenant priority level")
