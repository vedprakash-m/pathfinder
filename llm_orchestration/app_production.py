...
async def generate_llm_response(request: LLMRequest, background_tasks: BackgroundTasks):
...
async def get_usage_analytics(tenant_id: str = "default", period: str = "daily"):
    """Get usage analytics"""
    return {
        "tenant_id": tenant_id,
        "period": period,
