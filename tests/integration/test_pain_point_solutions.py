...
from backend.app.models.models import Trip, Family, User
from backend.app.services.consensus_engine import FamilyConsensusEngine, ConflictSeverity
from backend.app.services.coordination_automation import CoordinationAutomationService
from backend.app.services.real_time_feedback import RealTimeFeedbackService
